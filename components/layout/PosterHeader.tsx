    ...
    <header className="relative border-b-4 border-ink pb-6 mb-8">
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <h1 className="display text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-ink break-words">
            {trip.name}
          </h1>
          <div className="flex items-baseline gap-4 mt-3 flex-wrap">
            ...
            <div className="stamp text-xs text-ink">
              · {days} {days === 1 ? "day" : "days"}
            </div>
          </div>
          {subtitle && <div className="mt-3 text-sm text-ink/70 italic">{subtitle}</div>}
        </div>
        <div className="text-5xl sm:text-6xl lg:text-7xl leading-none shrink-0" aria-hidden>
          {trip.coverEmoji}
        </div>
      </div>
    </header>
